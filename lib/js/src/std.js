...
function map3$3(f, opt1, opt2, opt3) {
  if (opt1 && opt2 && opt3) {
...
function withDefault$2(defaultValue, opt) {
  if (opt) {
    return opt[0];
  } else {
    return defaultValue;
